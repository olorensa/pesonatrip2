        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="povince">{{ __('province') }}</label>
                        <input type="text" class="form-control" id="province" placeholder="{{ __('province') }}" name="province" value="{{ old('province') }}" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="duration" placeholder="{{ __('duration') }}" name="duration" value="{{ old('duration') }}" />
                    </div>
                    <div class="form-group">
