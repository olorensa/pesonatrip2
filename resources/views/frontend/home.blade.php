...
<div class="slider_area">
    <div class="slider_active owl-carousel">
        ...
        <div style="background-image: url( {{ asset(Storage::url($slider->image)) }} )"
                ...
                <div class="single_place">
                    <div class="thumb">
                        ...
                        <a href="{{ route('destination.show', $destination->city)}}"
                            class="prise">${{ $destination->price}}</a>
                    </div>
                    <div class="place_info">
                        ...
                        <div class="rating_days d-flex justify-content-between">
                            <div class="days">
                                ...
                                <a
                                    href="{{ route('destination.show', $destination->city)}}">{{ $destination->duration}}</a>
                            </div>
                        </div>
                    </div>
                </div>
